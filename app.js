...
function renderHero(){
return `<div class="hero"><div class="hero-badge">🧑‍💻 Complete Learning Platform · Beginner to Advanced · 2026</div><h1>Master Solana Smart Contract<br><span class="grad">Development from Zero to Pro</span></h1><p class="hero-sub">Your all-in-one platform to learn Solana — structured courses, 120+ practice questions, hands-on coding labs, mock interviews, and revision tools for every skill level.</p><div class="hero-stats"><div class="stat"><span class="stat-num">6</span><span class="stat-label">Modules</span></div><div class="stat"><span class="stat-num">120+</span><span class="stat-label">Questions</span></div><div class="stat"><span class="stat-num">6</span><span class="stat-label">Coding Labs</span></div><div class="stat"><span class="stat-num">3</span><span class="stat-label">Mock Rounds</span></div></div><a class="yt-hero-link" href="https://www.youtube.com/@upendrabuilds" target="_blank" rel="noopener">📺 Prefer video explanations? Watch visual guides →</a></div>`;
}
/* ── DASHBOARD ── */
